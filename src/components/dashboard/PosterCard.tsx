...
const PosterCard = ({ id, title, category, imageUrl, isNew = false }: PosterCardProps) => {
  ...
  const handleDownload = () => {
    ...
    // In a real implementation, this would call an API to generate the poster with the user's footer
    setTimeout(() => {
      setIsLoading(false);
